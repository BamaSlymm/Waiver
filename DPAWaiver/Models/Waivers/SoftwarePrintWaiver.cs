...
{
    public class SoftwarePrintWaiver : BaseWaiver
    {
        [Required]
        ...
        public SoftwarePrintWaiver(DPAUser createdBy, string otherFirstName, string otherLastName,
