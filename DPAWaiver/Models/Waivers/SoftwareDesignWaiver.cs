...
{
    public class SoftwareDesignWaiver : BaseWaiver
    {
        [Required]
        ...
        public SoftwareDesignWaiver(DPAUser createdBy, string otherFirstName, string otherLastName,
