...
{
    public class EquipmentPrintLargeFormatWaiver : BaseWaiver
    {
        ...
        public EquipmentPrintLargeFormatWaiver(DPAUser createdBy, string otherFirstName, string otherLastName,
        ...
        public EquipmentPrintLargeFormatWaiver()
        {
        }
