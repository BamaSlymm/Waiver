...
{
    public class EquipmentPrintPressWaiver : BaseWaiver
    {
        ...
        public EquipmentPrintPressWaiver(DPAUser createdBy, string otherFirstName, string otherLastName,
        ...
        public EquipmentPrintPressWaiver()
        {
        }
