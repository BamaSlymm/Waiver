...
{
    public class SoftwareScanningWaiver : BaseWaiver
    {
        [Required]
        ...
        public SoftwareScanningWaiver(DPAUser createdBy, string otherFirstName, string otherLastName,
