...
namespace DPAWaiver.Models {
    public class LOVService : ILOVService {
        ...
        public List<SingleFunctionPrinterPreferences> getSingleFunctionPrinterPreferences() {
            ...
            var m608dn =
                new SingleFunctionPrinterPreferences (2, "M608dn", 2, true, false, 867.0m, 292.99m, 12500, 0, 0, 0, 0, 0, 0);
            var m506dn =
                new SingleFunctionPrinterPreferences (3, "M506dn", 3, true, false, 574.0m, 305.99m, 9000, 0, 0, 0, 0, 0, 0);
            var m609dn =
                new SingleFunctionPrinterPreferences (4, "M609dn", 4, true, false, 1316.0m, 292.99m, 12500, 0, 0, 0, 0, 0, 0);
            var officeJet200 =
                new SingleFunctionPrinterPreferences (5, "OfficeJet 200", 5, true, false, 232.0m, 37.99m, 300, 0, 0, 0, 0, 0, 0);
            var m553dn =
                new SingleFunctionPrinterPreferences (6, "M553dn", 6, true, false, 610.0m, 221.99m, 6250, cyanTonerCost : 306.99m,
