...
namespace DPAWaiver.Pages {
    public class CreateWaiverEquipmentPrinterProductionCopierPressModel : PageModel {
        public void OnGet () {
        ...
        public CreateWaiverEquipmentPrinterProductionCopierPressModel (ILOVService iLOVService) {
