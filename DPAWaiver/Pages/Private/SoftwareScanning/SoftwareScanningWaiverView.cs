...
{
    public class SoftwareScanningWaiverView
    {  [Display(Name = "Waiver Owner First Name")]
        ...
        public SoftwareScanningWaiverView(SoftwareScanningWaiver other)
        {
            this.CopyFromSoftwareScanningWaiver(other);
        }

public void CopyFromSoftwareScanningWaiver(SoftwareScanningWaiver other) {
        ...
        public SoftwareScanningWaiverView()
        {
        }
