...
{
    public class EquipmentPrintLargeFormatWaiverView
    {  [Display(Name = "Waiver Owner First Name")]
        ...
        public EquipmentPrintLargeFormatWaiverView(EquipmentPrintLargeFormatWaiver other)
        {
            this.CopyFromEquipmentPrintLargeFormatWaiver(other);
        }

public void CopyFromEquipmentPrintLargeFormatWaiver(EquipmentPrintLargeFormatWaiver other) {
        ...
        public EquipmentPrintLargeFormatWaiverView()
        {
        }
