...
{
    public class EquipmentPrintPressWaiverView
    {  [Display(Name = "Waiver Owner First Name")]
        ...
        public EquipmentPrintPressWaiverView(EquipmentPrintPressWaiver other)
        {
            this.CopyFromEquipmentPrintPressWaiver(other);
        }

public void CopyFromEquipmentPrintPressWaiver(EquipmentPrintPressWaiver other) {
        ...
        public EquipmentPrintPressWaiverView()
        {
        }
