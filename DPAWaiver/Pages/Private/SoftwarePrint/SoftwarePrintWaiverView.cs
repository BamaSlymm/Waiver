...
{
    public class SoftwarePrintWaiverView
    {  [Display(Name = "Waiver Owner First Name")]
        ...
        public SoftwarePrintWaiverView(SoftwarePrintWaiver other)
        {
            this.CopyFromSoftwarePrintWaiver(other);
        }

public void CopyFromSoftwarePrintWaiver(SoftwarePrintWaiver other) {
        ...
        public SoftwarePrintWaiverView()
        {
        }
