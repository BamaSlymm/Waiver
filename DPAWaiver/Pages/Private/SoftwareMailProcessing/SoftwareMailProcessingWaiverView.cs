...
{
    public class SoftwareMailProcessingWaiverView
    {  [Display(Name = "Waiver Owner First Name")]
        ...
        public SoftwareMailProcessingWaiverView(SoftwareMailProcessingWaiver other)
        {
            this.CopyFromSoftwareMailProcessingWaiver(other);
        }

public void CopyFromSoftwareMailProcessingWaiver(SoftwareMailProcessingWaiver other) {
        ...
        public SoftwareMailProcessingWaiverView()
        {
        }
